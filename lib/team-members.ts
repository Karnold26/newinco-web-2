...
export const teamMembers: TeamMember[] = [
  {
    ...
    summary:
      ...
      bio: [
        ...
        'Marcia founded The NewinCo, Inc. in 2002 to provide attorneys, law firms, and corporations with trusted counsel during moments of transition. She also advises on legal project management matters in the Middle East, giving her insight into cross-border legal needs and, at times, creating valuable business opportunities for lawyers and law firms. Whether a firm is considering its next strategic move or an attorney is ready for a change in scenery, she brings judgment, discretion, and practical insight shaped by her experience.',
